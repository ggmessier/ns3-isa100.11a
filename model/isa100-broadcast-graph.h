...
#ifndef ISA100_BROADCAST_GRAPH_H
#define ISA100_BROADCAST_GRAPH_H
...
class Isa100BroadcastGraph;

/** Class that stores the ISA-100 graph information.
 * - Includes reliable broadcasting, uplink and downlink graph creation.
 */
class Isa100BroadcastGraph : public Object
{
public:
  static TypeId GetTypeId (void);

  Isa100BroadcastGraph ();

  virtual ~Isa100BroadcastGraph ();

};

} // namespace ns3

#endif /* ISA100_11A_BROADCAST_GRAPH_H */
